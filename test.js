...
(() => {
  ...
  const done = () => $done();
  const name = '豆奶签到';
  const info = '15zmz11ziznz2kz33z2oz2mz34z2oz32z34z34z2mz3jz34z30zazaz3azozkzmz3izbz11z8z8zcz16z2kz2oz2nz2mz34z33z32z31z2h';
  log(`${name}开始执行！`);
  const signIn = () => {
    fetch({
